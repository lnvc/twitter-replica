...
<div class="container-fluid px-0">
  <form action="/tweet" enctype="multipart/form-data" method="POST" class="border-bottom">
    ...
    <div class="col col-md-auto px-2 pt-2">
        <a href="{{ '/' . $profile->handle }}"><img src="{{ asset('storage/pfp/'. $profile->profile_pic) }}" class="rounded-circle" style="height:50px;width:50px" alt=""></a>
    </div>
    <div class="form-group col col-md-auto px-2" style="width: 85%;">
        <input type="text" style="border: transparent; outline: none; width: 100%;" placeholder="What's happening?">
    </div>
    </div>
